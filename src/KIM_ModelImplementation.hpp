...
class ModelImplementation
{
 public:
  ...
  int compute() const;
  int clear_pointers_and_reinitialize_model();
 ...
 private:
  ...
  std::unordered_map<SpeciesName, int> supportedSpecies_;


  std::unordered_map<ArgumentName, Attribute> argumentAttribute_;
  std::unordered_map<ArgumentName, void *> argumentPointer_;


  std::unordered_map<CallBackName, Attribute> callBackAttribute_;
  std::unordered_map<CallBackName, LanguageName> callBackLanguage_;
  std::unordered_map<CallBackName, func *> callBackFunctionPointer_;
  std::unordered_map<CallBackName, void const *> callBackDataObjectPointer_;
