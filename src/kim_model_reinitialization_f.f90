...
module kim_model_reinitialization_f_module
  ...
  interface
    ...
    subroutine log(model_reinitialization, log_level, message, line_number, &
      file_name) bind(c, name="KIM_ModelReinitialization_Log")
      use, intrinsic :: iso_c_binding
      use kim_model_reinitialization_module, only : &
        kim_model_reinitialization_type
...
subroutine kim_model_reinitialization_log(model_reinitialization, log_level, &
  ...
  call log(model_reinitialization, log_level, trim(message)//c_null_char, &
