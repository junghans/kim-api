...
module kim_model_initialization_f_module
  ...
  interface
    ...
    subroutine log(model_initialization, log_level, message, line_number, &
...
subroutine kim_model_initialization_log(model_initialization, log_level, &
  ...
  call log(model_initialization, log_level, trim(message)//c_null_char, &
